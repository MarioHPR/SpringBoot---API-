...
public class InstituicaoRepositoryTest {
    ...
    @Test
    public void buscarInstituicaoPorId() {
        assertTrue(instituicaoRepository.findById(1).isPresent());
    }

    @Test
    public void buscarInstituicaoPorNome() {
        assertEquals("Hospital", instituicaoRepository.findByNome("Hospital").getNome());
    }

    @Test
    public void buscarInstituicaoPorIdInexistenteRetornarFalse(){
        assertFalse(instituicaoRepository.findById(2).isPresent());
    }

    @Test
    public void buscarInstituicaoPorNomeInexistenteRetornarNull(){
        assertNull(instituicaoRepository.findByNome("Escritorio"));
    }
